...
function guessTeam(name) {
  const map = {
    ...
    // DAL
    'kyrie irving':'DAL','klay thompson':'DAL','p.j. washington':'DAL','dereck lively ii':'DAL','naji marshall':'DAL','dante exum':'DAL','marvin bagley iii':'DAL','dwight powell':'DAL','daniel gafford':'DAL',
    // DEN
